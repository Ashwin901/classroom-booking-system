...
database.connect((err) => {
  if (err) {
    ...
    let createBooking = `create table if not exists booking(room_id int, roomNumber varchar(8), name varchar(15), email varchar(18),phoneNumber varchar(18), event varchar(15), start_time Time(5), duration varchar(2), event_date varchar(12), foreign key (room_id) references rooms(room_id));`;
